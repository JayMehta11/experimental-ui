...
const imageNames: string[] = [
  ...
  "dalle3-a robot expressing the emotion affecion-1.webp",
  "dalle3-a robot expressing the emotion affecion-2.webp",
  "dalle3-a robot expressing the emotion affecion-3.webp",
  "dalle3-a robot expressing the emotion affecion-4.webp",
